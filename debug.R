...
# dir_data <- paste0('../data/account-statement_2025-01-01_2025-02-28_fr-fr_1c5df2.csv')
...
for(script_i in list.files('R')) source(paste0('R/', script_i))
...
all_dir <- '../data/account-statement_2025-01-01_2025-02-28_fr-fr_1c5df2.csv'
